...
export CLANG_TCHAIN="/home/vicatz/toolchains/alize-clang/clang-4536805/bin/clang"
...
export ZIP_NAME="wayang™${V}_Nougat-Miui.zip"
...
zipit () {
	...
	${TOOL_CHAIN_PATH}strip --strip-unneeded ${ZIPPER_DIR}/system/lib/modules/*.ko &> /dev/null
